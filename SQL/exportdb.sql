...
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `Books` (
  `BookID` int(11) NOT NULL AUTO_INCREMENT,    -- Auto-incrementing primary key for the book identifier
  `BookName` varchar(50) NOT NULL,             -- Name of the book, required
  `Genre` varchar(10) NOT NULL,                -- Genre of the book, required
  `Author` varchar(30) DEFAULT NULL,           -- Name of the author, optional
  `Publisher` varchar(30) DEFAULT NULL,        -- Name of the publisher, optional
  `Shelf` varchar(5) NOT NULL,                 -- Shelf location, required
  `Row` varchar(5) NOT NULL,                   -- Row location, required
  PRIMARY KEY (`BookID`)                       -- Primary key constraint on BookID
...
INSERT INTO `Users` VALUES (1,'1234','2012-05-15','Deco','deco@gmail.com'),(2,'12345678','2016-11-07','Mark','markde4@gmail.net'),(3,'012345','2016-11-25','NewHero','newhero@gmail.com');
